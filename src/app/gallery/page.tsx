      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-14">
          ...
          <p className="max-w-2xl text-lg text-gray-500 dark:text-gray-400">
            Real results from our patients. Each case study includes the treatment approach,
        ...
        <div className="mt-12 flex items-start gap-4 rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
          ...
          <div>
            <p className="mb-1 font-semibold text-gray-800 dark:text-white">
              All cases published with patient consent
            </p>
            <p className="text-sm leading-relaxed text-gray-500 dark:text-gray-400">
              Photos are published exclusively with written patient consent. Patient identity
              remains strictly confidential. Contact us for more information about any specific
              treatment.
            </p>
          </div>
        </div>
        ...
        <div className="mt-20 text-center">
          <p className="mb-6 text-gray-500 dark:text-gray-400">
            Interested in a similar treatment?
          </p>
          <Link
            href="/#contact"
