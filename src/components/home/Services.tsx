...
const Services = () => {
  ...
  return (
    <section id="services" className="bg-slate-50 py-24 dark:bg-gray-900">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {servicesItems.map((service, index) => (
            <div
              ...
              {/* Icon */}
              <div
                className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-xl ${service.iconContainerClassName}`}>
                <Icon
              ...
              <div className="min-w-0">
                <h3 className={`mb-1.5 text-lg font-semibold ${service.textClassName}`}>
                  {t(service.title)}
                </h3>
