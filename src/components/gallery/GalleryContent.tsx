      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-14">
          ...
          <p className="max-w-2xl text-lg text-gray-500 dark:text-gray-400">
            {t('Stvarni rezultati naših pacijenata. Svaki slučaj uključuje pristup tretmanu, vremenski okvir i ishod.')}
          </p>
        </div>
                ...
                <div className="flex flex-1 flex-col justify-center p-8 lg:p-12">
                  ...
                  <div className="mb-6 grid gap-4 sm:grid-cols-2">
                    ...
                    <div className="bg-accent/60 dark:bg-primary/10 rounded-xl p-4">
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-300">{t(study.solution)}</p>
                    </div>
                  </div>
        ...
        <div className="mt-12 flex items-start gap-4 rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed text-gray-500 dark:text-gray-400">
              {t('Fotografije se objavljuju isključivo uz pisanu saglasnost pacijenta. Identitet pacijenta ostaje strogo poverljiv. Kontaktirajte nas za više informacija o specifičnom tretmanu.')}
            </p>
          </div>
        </div>
